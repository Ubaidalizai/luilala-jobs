...
//       try {
//         const response = await axios.get('http://127.0.0.1:3000/api/v1/testimonial/getTestimonial'); // Replace with your API endpoint
...
//                           ))}
//                         </div>
//                         <div className="text-gray-500">{new Date(reviews[currentIndex].createdAt).toLocaleDateString()}</div>
//                         <div className="mt-2">{reviews[currentIndex].text}</div>
//                         <div className="mt-4 text-gray-700 font-bold">{reviews[currentIndex].userId.fullName}</div>
//                       </div>
//                     )
//                   )}
//                 </div>
//                 <div className="absolute top-1/2 transform -translate-y-1/2 flex justify-between w-full px-4">
//                   <button className="bg-white rounded-full p-2 shadow-md hover:bg-gray-200 transition-colors" onClick={handlePrevClick} disabled={isLoading || reviews.length === 0}>
//                     <FaChevronLeft />
//                   </button>
//                   <button className="bg-white rounded-full p-2 shadow-md hover:bg-gray-200 transition-colors" onClick={handleNextClick} disabled={isLoading || reviews.length === 0}>
//                     <FaChevronRight />
//                   </button>
//                 </div>
//               </div>
        ...
        <div className="w-full max-w-4xl mx-auto">
          <div className="flex flex-col lg:flex-row bg-white shadow-lg rounded-lg overflow-hidden">
            <div className="p-8 bg-[#002244] text-white flex-shrink-0">
              ...
              <div className="mt-2">
                {/* Show the total count of reviews */}
